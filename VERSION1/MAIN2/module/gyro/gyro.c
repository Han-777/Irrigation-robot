...
void UART5_IRQHandler(void)
{
	...
	if (USART_GetITStatus(UART5, USART_IT_RXNE) == SET) // Check if data is received //�ж��Ƿ���յ�����?
	{
		USART_ClearITPendingBit(UART5, USART_IT_RXNE);
		Usart_Receive = USART_ReceiveData(UART5);									   // Read the data //��ȡ����
		Fd_data[Count] = Usart_Receive;												   // ����������������
		if (((last_rsnum == FRAME_END) && (Usart_Receive == FRAME_HEAD)) || Count > 0) // ���¶�֡
		{
			rs_count = 1;
			Count++;
...
// void N100N_Turn_90angles(int site, float kp, float ki, float kd) // site��ʾת�䷽��0Ϊ��1Ϊ��
//{
//	//	if(site==1)
//	//	{
//	//		if(N_Flag==5)
//	//		{
//	//
//	////			TIM7_Int_Init(1000-1,840-1);//10ms����һ���ж�s
//	////			delay_ms(100);
//	////			site=0;
//	////
//	//			Car_Load(100,100);
...
//				F_L = 1;
//				delay_ms(200);
//				TIM7_Int_Init(1000 - 1, 840 - 1); // �򿪶�ʱ��
//				delay_ms(1200);
//				FLAG = 1;
//				set = 0;
...
//					Err_R_Angle = -3;
//				}
//				PWM_Turn = (kp * Err_R_Angle) + (kd * (Err_R_Angle - Err_R_Lats_Angle)); // Ч��������ÿ��Ի����������ٶ�?
