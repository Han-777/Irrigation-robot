...
ErrorStatus LL_RTC_Init(RTC, LL_RTC_InitTypeDef* RTC_InitStruct)
{
  ...
  assert_param(IS_RTC_HOUR_FORMAT(RTC_InitStruct->HourFormat));
  assert_param(IS_RTC_ASYNCH_PREDIV(RTC_InitStruct->AsynchPrescaler));
  assert_param(IS_RTC_SYNCH_PREDIV(RTC_InitStruct->SynchPrescaler));
  ...
  else
  {
    ...
    /* Set RTC_CR register */
    RTC->CR |=  ((uint32_t)(RTC_InitStruct->HourFormat));
  
    /* Configure the RTC PRER */
    RTC->PRER = (uint32_t)(RTC_InitStruct->SynchPrescaler);
    RTC->PRER |= (uint32_t)(RTC_InitStruct->AsynchPrescaler << 16);
...
void LL_RTC_StructInit(LL_RTC_InitTypeDef* RTC_InitStruct)
{
  ...
  RTC_InitStruct->AsynchPrescaler = (uint32_t)0x7F;

  /* Initialize the RTC_SynchPrediv member */
  RTC_InitStruct->SynchPrescaler = (uint32_t)0xFF; 
}
...
ErrorStatus LL_RTC_TIME_Init(RTC, uint32_t RTC_Format, LL_RTC_TimeTypeDef* RTC_TimeStruct)
{
  ...
  if (RTC_Format == LL_RTC_FORMAT_BIN)
  {
    ...
    {
      assert_param(IS_RTC_HOUR12(RTC_TimeStruct->Hours));
      assert_param(IS_RTC_H12(RTC_TimeStruct->TimeFormat));
    } 
    else
    {
      RTC_TimeStruct->TimeFormat = 0x00;
      assert_param(IS_RTC_HOUR24(RTC_TimeStruct->Hours));
    }
  ...
  else
  {
    if ((RTC->CR & RTC_CR_FMT) != (uint32_t)RESET)
    {
      tmpreg = RTC_Bcd2ToByte(RTC_TimeStruct->Hours);
    ...
    {
      RTC_TimeStruct->TimeFormat = 0x00;
      assert_param(IS_RTC_HOUR24(RTC_Bcd2ToByte(RTC_TimeStruct->Hours)));
    }
  ...
  if (RTC_Format != LL_RTC_FORMAT_BIN)
  {
    tmpreg = (((uint32_t)(RTC_TimeStruct->Hours) << 16) | \
             ((uint32_t)(RTC_TimeStruct->Minutes) << 8) | \
             ((uint32_t)RTC_TimeStruct->Seconds) | \
             ((uint32_t)(RTC_TimeStruct->TimeFormat) << 16)); 
  }  
  else
  {
    tmpreg = (uint32_t)(((uint32_t)RTC_ByteToBcd2(RTC_TimeStruct->Hours) << 16) | \
                   ((uint32_t)RTC_ByteToBcd2(RTC_TimeStruct->Minutes) << 8) | \
                   ((uint32_t)RTC_ByteToBcd2(RTC_TimeStruct->Seconds)) | \
                   (((uint32_t)RTC_TimeStruct->TimeFormat) << 16));
  }  
...
ErrorStatus LL_RTC_DATE_Init(RTC, uint32_t RTC_Format, LL_RTC_DateTypeDef* RTC_DateStruct)
{
  ...
  if ((RTC_Format == LL_RTC_FORMAT_BIN) && ((RTC_DateStruct->Month & 0x10) == 0x10))
  {
  ...
  if (RTC_Format == LL_RTC_FORMAT_BIN)
  {
    ...
    assert_param(IS_RTC_DATE(RTC_DateStruct->Day));
  }
  else
  {
    assert_param(IS_RTC_YEAR(RTC_Bcd2ToByte(RTC_DateStruct->Year)));
    tmpreg = RTC_Bcd2ToByte(RTC_DateStruct->Month);
    assert_param(IS_RTC_MONTH(tmpreg));
    tmpreg = RTC_Bcd2ToByte(RTC_DateStruct->Day);
  ...
  if (RTC_Format != LL_RTC_FORMAT_BIN)
  {
    tmpreg = ((((uint32_t)RTC_DateStruct->Year) << 16) | \
              (((uint32_t)RTC_DateStruct->Month) << 8) | \
              ((uint32_t)RTC_DateStruct->Day) | \
              (((uint32_t)RTC_DateStruct->WeekDay) << 13)); 
  }  
  else
  {
    tmpreg = (((uint32_t)RTC_ByteToBcd2(RTC_DateStruct->Year) << 16) | \
              ((uint32_t)RTC_ByteToBcd2(RTC_DateStruct->Month) << 8) | \
              ((uint32_t)RTC_ByteToBcd2(RTC_DateStruct->Day)) | \
              ((uint32_t)RTC_DateStruct->WeekDay << 13));
  }
...
void RTC_GetDate(uint32_t RTC_Format, LL_RTC_DateTypeDef* RTC_DateStruct)
{
  ...
  RTC_DateStruct->Day = (uint8_t)(tmpreg & (RTC_DR_DT | RTC_DR_DU));
  ...
  if (RTC_Format == LL_RTC_FORMAT_BIN)
  {
    ...
    RTC_DateStruct->Day = (uint8_t)RTC_Bcd2ToByte(RTC_DateStruct->Day);
  }
}
...
void RTC_SetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm, LL_RTC_AlarmTypeDef* RTC_AlarmStruct)
{
  ...
  assert_param(IS_RTC_ALARM_DATE_WEEKDAY_SEL(RTC_AlarmStruct->AlarmDateWeekDaySel));

  if (RTC_Format == LL_RTC_FORMAT_BIN)
  {
    if ((RTC->CR & RTC_CR_FMT) != (uint32_t)RESET)
    {
      assert_param(IS_RTC_HOUR12(RTC_AlarmStruct->AlarmTime.Hours));
      assert_param(IS_RTC_H12(RTC_AlarmStruct->AlarmTime.TimeFormat));
    } 
    else
    {
      RTC_AlarmStruct->AlarmTime.TimeFormat = 0x00;
      assert_param(IS_RTC_HOUR24(RTC_AlarmStruct->AlarmTime.Hours));
    }
    ...
    {
      assert_param(IS_RTC_ALARM_DATE_WEEKDAY_DATE(RTC_AlarmStruct->AlarmDateWeekDay));
    }
    else
    {
      assert_param(IS_RTC_ALARM_DATE_WEEKDAY_WEEKDAY(RTC_AlarmStruct->AlarmDateWeekDay));
    }
  }
  else
  {
    if ((RTC->CR & RTC_CR_FMT) != (uint32_t)RESET)
    {
      tmpreg = RTC_Bcd2ToByte(RTC_AlarmStruct->AlarmTime.Hours);
      assert_param(IS_RTC_HOUR12(tmpreg));
      assert_param(IS_RTC_H12(RTC_AlarmStruct->AlarmTime.TimeFormat));
    } 
    else
    {
      RTC_AlarmStruct->AlarmTime.TimeFormat = 0x00;
      assert_param(IS_RTC_HOUR24(RTC_Bcd2ToByte(RTC_AlarmStruct->AlarmTime.Hours)));
    }
    ...
    if(RTC_AlarmStruct->AlarmDateWeekDaySel == LL_RTC_ALMA_DATEWEEKDAYSEL_DATE)
    {
      tmpreg = RTC_Bcd2ToByte(RTC_AlarmStruct->AlarmDateWeekDay);
  ...
  if (RTC_Format != LL_RTC_FORMAT_BIN)
  {
    tmpreg = (((uint32_t)(RTC_AlarmStruct->AlarmTime.Hours) << 16) | \
              ((uint32_t)(RTC_AlarmStruct->AlarmTime.Minutes) << 8) | \
              ((uint32_t)RTC_AlarmStruct->AlarmTime.Seconds) | \
              ((uint32_t)(RTC_AlarmStruct->AlarmTime.TimeFormat) << 16) | \
              ((uint32_t)(RTC_AlarmStruct->AlarmDateWeekDay) << 24) | \
              ((uint32_t)RTC_AlarmStruct->AlarmDateWeekDaySel) | \
              ((uint32_t)RTC_AlarmStruct->AlarmMask)); 
  }  
  else
  {
    tmpreg = (((uint32_t)RTC_ByteToBcd2(RTC_AlarmStruct->AlarmTime.Hours) << 16) | \
              ((uint32_t)RTC_ByteToBcd2(RTC_AlarmStruct->AlarmTime.Minutes) << 8) | \
              ((uint32_t)RTC_ByteToBcd2(RTC_AlarmStruct->AlarmTime.Seconds)) | \
              ((uint32_t)(RTC_AlarmStruct->AlarmTime.TimeFormat) << 16) | \
              ((uint32_t)RTC_ByteToBcd2(RTC_AlarmStruct->AlarmDateWeekDay) << 24) | \
              ((uint32_t)RTC_AlarmStruct->AlarmDateWeekDaySel) | \
              ((uint32_t)RTC_AlarmStruct->AlarmMask)); 
  } 
...
void RTC_GetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm, LL_RTC_AlarmTypeDef* RTC_AlarmStruct)
{
  ...
  RTC_AlarmStruct->AlarmTime.Hours = (uint32_t)((tmpreg & (RTC_ALRMAR_HT | \
                                                     RTC_ALRMAR_HU)) >> 16);
  RTC_AlarmStruct->AlarmTime.Minutes = (uint32_t)((tmpreg & (RTC_ALRMAR_MNT | \
                                                     RTC_ALRMAR_MNU)) >> 8);
  RTC_AlarmStruct->AlarmTime.Seconds = (uint32_t)(tmpreg & (RTC_ALRMAR_ST | \
                                                     RTC_ALRMAR_SU));
  RTC_AlarmStruct->AlarmTime.TimeFormat = (uint32_t)((tmpreg & RTC_ALRMAR_PM) >> 16);
  RTC_AlarmStruct->AlarmDateWeekDay = (uint32_t)((tmpreg & (RTC_ALRMAR_DT | RTC_ALRMAR_DU)) >> 24);
  RTC_AlarmStruct->AlarmDateWeekDaySel = (uint32_t)(tmpreg & RTC_ALRMAR_WDSEL);
  RTC_AlarmStruct->AlarmMask = (uint32_t)(tmpreg & LL_RTC_ALMA_MASK_ALL);

  if (RTC_Format == LL_RTC_FORMAT_BIN)
  {
    RTC_AlarmStruct->AlarmTime.Hours = RTC_Bcd2ToByte(RTC_AlarmStruct-> \
                                                        RTC_AlarmTime.Hours);
    RTC_AlarmStruct->AlarmTime.Minutes = RTC_Bcd2ToByte(RTC_AlarmStruct-> \
                                                        RTC_AlarmTime.Minutes);
    RTC_AlarmStruct->AlarmTime.Seconds = RTC_Bcd2ToByte(RTC_AlarmStruct-> \
                                                        RTC_AlarmTime.Seconds);
    RTC_AlarmStruct->AlarmDateWeekDay = RTC_Bcd2ToByte(RTC_AlarmStruct->AlarmDateWeekDay);
  }  
}
                                      ...
                                      LL_RTC_DateTypeDef* RTC_StampDateStruct)
{
  ...
  RTC_StampTimeStruct->Hours = (uint8_t)((tmptime & (RTC_TR_HT | RTC_TR_HU)) >> 16);
  RTC_StampTimeStruct->Minutes = (uint8_t)((tmptime & (RTC_TR_MNT | RTC_TR_MNU)) >> 8);
  RTC_StampTimeStruct->Seconds = (uint8_t)(tmptime & (RTC_TR_ST | RTC_TR_SU));
  RTC_StampTimeStruct->TimeFormat = (uint8_t)((tmptime & (RTC_TR_PM)) >> 16);  

  /* Fill the Date structure fields with the read parameters */
  RTC_StampDateStruct->Year = 0;
  RTC_StampDateStruct->Month = (uint8_t)((tmpdate & (RTC_DR_MT | RTC_DR_MU)) >> 8);
  RTC_StampDateStruct->Day = (uint8_t)(tmpdate & (RTC_DR_DT | RTC_DR_DU));
  RTC_StampDateStruct->WeekDay = (uint8_t)((tmpdate & (RTC_DR_WDU)) >> 13);
  ...
  if (RTC_Format == LL_RTC_FORMAT_BIN)
  {
    ...
    RTC_StampDateStruct->Day = (uint8_t)RTC_Bcd2ToByte(RTC_StampDateStruct->Day);
