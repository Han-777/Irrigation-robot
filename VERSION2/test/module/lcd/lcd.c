...
{ 	
	...
	LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_GPIOB|LL_AHB1_GRP1_PERIPH_GPIOD|LL_AHB1_GRP1_PERIPH_GPIOE|LL_AHB1_GRP1_PERIPH_GPIOF|LL_AHB1_GRP1_PERIPH_GPIOG);//使能PD,PE,PF,PG时钟  
	LL_AHB3_GRP1_EnableClock(LL_AHB3_GRP1_PERIPH_FSMC);//使能FSMC时钟  


	GPIO_InitStructure.Pin = LL_GPIO_PIN_15;//PB15 推挽输出,控制背光
	GPIO_InitStructure.Mode = LL_GPIO_MODE_OUTPUT;//普通输出模式
	GPIO_InitStructure.OutputType = LL_GPIO_OUTPUT_PUSHPULL;//推挽输出
	GPIO_InitStructure.Speed = LL_GPIO_SPEED_FREQ_HIGH;//100MHz
	GPIO_InitStructure.Pull = LL_GPIO_PULL_UP;//上拉
	GPIO_InitStructure.Alternate = LL_GPIO_AF_0;
	LL_GPIO_Init(GPIOB, &GPIO_InitStructure);//初始化 //PB15 推挽输出,控制背光

	GPIO_InitStructure.Pin = (3<<0)|(3<<4)|(7<<8)|(3<<14);//PD0,1,4,5,8,9,10,14,15 AF OUT
	GPIO_InitStructure.Mode = LL_GPIO_MODE_ALTERNATE;//复用输出
	GPIO_InitStructure.OutputType = LL_GPIO_OUTPUT_PUSHPULL;//推挽输出
	GPIO_InitStructure.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;//100MHz
	GPIO_InitStructure.Pull = LL_GPIO_PULL_UP;//上拉
	GPIO_InitStructure.Alternate = LL_GPIO_AF_0;
	LL_GPIO_Init(GPIOD, &GPIO_InitStructure);//初始化  
	...
	GPIO_InitStructure.Pull = LL_GPIO_PULL_UP;//上拉
	GPIO_InitStructure.Alternate = LL_GPIO_AF_0;
	LL_GPIO_Init(GPIOE, &GPIO_InitStructure);//初始化  

	GPIO_InitStructure.Pin = LL_GPIO_PIN_12;//PF12,FSMC_A6
	GPIO_InitStructure.Mode = LL_GPIO_MODE_ALTERNATE;//复用输出
	GPIO_InitStructure.OutputType = LL_GPIO_OUTPUT_PUSHPULL;//推挽输出
	GPIO_InitStructure.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;//100MHz
	GPIO_InitStructure.Pull = LL_GPIO_PULL_UP;//上拉
	GPIO_InitStructure.Alternate = LL_GPIO_AF_0;
	LL_GPIO_Init(GPIOF, &GPIO_InitStructure);//初始化  
	...
	GPIO_InitStructure.Pull = LL_GPIO_PULL_UP;//上拉
	GPIO_InitStructure.Alternate = LL_GPIO_AF_0;
	LL_GPIO_Init(GPIOG, &GPIO_InitStructure);//初始化 

	LL_GPIO_SetAFPin_0_7(GPIOD, LL_GPIO_PIN_0, LL_GPIO_AF_12);//PD0,AF12
	LL_GPIO_SetAFPin_0_7(GPIOD, LL_GPIO_PIN_1, LL_GPIO_AF_12);//PD1,AF12
	LL_GPIO_SetAFPin_0_7(GPIOD, LL_GPIO_PIN_4, LL_GPIO_AF_12);
	LL_GPIO_SetAFPin_0_7(GPIOD, LL_GPIO_PIN_5, LL_GPIO_AF_12); 
	LL_GPIO_SetAFPin_8_15(GPIOD, LL_GPIO_PIN_8, LL_GPIO_AF_12); 
	LL_GPIO_SetAFPin_8_15(GPIOD, LL_GPIO_PIN_9, LL_GPIO_AF_12);
	LL_GPIO_SetAFPin_8_15(GPIOD, LL_GPIO_PIN_10, LL_GPIO_AF_12);
	LL_GPIO_SetAFPin_8_15(GPIOD, LL_GPIO_PIN_14, LL_GPIO_AF_12);
	LL_GPIO_SetAFPin_8_15(GPIOD, LL_GPIO_PIN_15, LL_GPIO_AF_12);//PD15,AF12

	LL_GPIO_SetAFPin_0_7(GPIOE, LL_GPIO_PIN_7, LL_GPIO_AF_12);//PE7,AF12
	LL_GPIO_SetAFPin_8_15(GPIOE, LL_GPIO_PIN_8, LL_GPIO_AF_12);
	LL_GPIO_SetAFPin_8_15(GPIOE, LL_GPIO_PIN_9, LL_GPIO_AF_12);
	LL_GPIO_SetAFPin_8_15(GPIOE, LL_GPIO_PIN_10, LL_GPIO_AF_12);
	LL_GPIO_SetAFPin_8_15(GPIOE, LL_GPIO_PIN_11, LL_GPIO_AF_12);
	LL_GPIO_SetAFPin_8_15(GPIOE, LL_GPIO_PIN_12, LL_GPIO_AF_12);
	LL_GPIO_SetAFPin_8_15(GPIOE, LL_GPIO_PIN_13, LL_GPIO_AF_12);
	LL_GPIO_SetAFPin_8_15(GPIOE, LL_GPIO_PIN_14, LL_GPIO_AF_12);
	LL_GPIO_SetAFPin_8_15(GPIOE, LL_GPIO_PIN_15, LL_GPIO_AF_12);//PE15,AF12

	LL_GPIO_SetAFPin_8_15(GPIOF, LL_GPIO_PIN_12, LL_GPIO_AF_12);//PF12,AF12
	LL_GPIO_SetAFPin_8_15(GPIOG, LL_GPIO_PIN_12, LL_GPIO_AF_12);
