...
#define LL_TIM_DMABURST_BASEADDR_OR                     ((uint16_t)0x0013)
#define IS_TIM_DMA_BASE(BASE) (((BASE) == LL_TIM_DMABURST_BASEADDR_CR1) || \
                               ...
                               ((BASE) == LL_TIM_DMABURST_BASEADDR_OR))                     
/**
  * @}
  */ 
...
#define LL_TIM_TIM2_ITR1_RMP_TIM8_TRGO                     ((uint16_t)0x0000)
#define LL_TIM_TIM2_ITR1_RMP_ETH_PTP                       ((uint16_t)0x0400)
#define LL_TIM_TIM2_ITR1_RMP_OTG_FS_SOF                     ((uint16_t)0x0800)
#define LL_TIM_TIM2_ITR1_RMP_OTG_HS_SOF                     ((uint16_t)0x0C00)

#define LL_TIM_TIM5_TI4_RMP_GPIO                          ((uint16_t)0x0000)
#define LL_TIM_TIM5_TI4_RMP_LSI                           ((uint16_t)0x0040)
#define LL_TIM_TIM5_TI4_RMP_LSE                           ((uint16_t)0x0080)
#define LL_TIM_TIM5_TI4_RMP_RTC                           ((uint16_t)0x00C0)

#define LL_TIM_TIM11_TI1_RMP_GPIO                         ((uint16_t)0x0000)
#define LL_TIM_TIM11_TI1_RMP_HSE_RTC                          ((uint16_t)0x0002)

#define IS_TIM_REMAP(TIM_REMAP)	 (((TIM_REMAP) == LL_TIM_TIM2_ITR1_RMP_TIM8_TRGO)||\
                                  ((TIM_REMAP) == LL_TIM_TIM2_ITR1_RMP_ETH_PTP)||\
                                  ((TIM_REMAP) == LL_TIM_TIM2_ITR1_RMP_OTG_FS_SOF)||\
                                  ((TIM_REMAP) == LL_TIM_TIM2_ITR1_RMP_OTG_HS_SOF)||\
                                  ((TIM_REMAP) == LL_TIM_TIM5_TI4_RMP_GPIO)||\
                                  ((TIM_REMAP) == LL_TIM_TIM5_TI4_RMP_LSI)||\
                                  ((TIM_REMAP) == LL_TIM_TIM5_TI4_RMP_LSE)||\
                                  ((TIM_REMAP) == LL_TIM_TIM5_TI4_RMP_RTC)||\
                                  ((TIM_REMAP) == LL_TIM_TIM11_TI1_RMP_GPIO)||\
                                  ((TIM_REMAP) == LL_TIM_TIM11_TI1_RMP_HSE_RTC))
...
#define LL_TIM_DMABURST_LENGTH_1TRANSFER           LL_TIM_DMABURST_LENGTH_1TRANSFER
#define LL_TIM_DMABURST_LENGTH_2TRANSFERS          LL_TIM_DMABURST_LENGTH_2TRANSFERS
#define LL_TIM_DMABURST_LENGTH_3TRANSFERS          LL_TIM_DMABURST_LENGTH_3TRANSFERS
#define LL_TIM_DMABURST_LENGTH_4TRANSFERS          LL_TIM_DMABURST_LENGTH_4TRANSFERS
#define LL_TIM_DMABURST_LENGTH_5TRANSFERS          LL_TIM_DMABURST_LENGTH_5TRANSFERS
#define LL_TIM_DMABURST_LENGTH_6TRANSFERS          LL_TIM_DMABURST_LENGTH_6TRANSFERS
#define LL_TIM_DMABURST_LENGTH_7TRANSFERS          LL_TIM_DMABURST_LENGTH_7TRANSFERS
#define LL_TIM_DMABURST_LENGTH_8TRANSFERS          LL_TIM_DMABURST_LENGTH_8TRANSFERS
#define LL_TIM_DMABURST_LENGTH_9TRANSFERS          LL_TIM_DMABURST_LENGTH_9TRANSFERS
#define LL_TIM_DMABURST_LENGTH_10TRANSFERS         LL_TIM_DMABURST_LENGTH_10TRANSFERS
#define LL_TIM_DMABURST_LENGTH_11TRANSFERS         LL_TIM_DMABURST_LENGTH_11TRANSFERS
#define LL_TIM_DMABURST_LENGTH_12TRANSFERS         LL_TIM_DMABURST_LENGTH_12TRANSFERS
#define LL_TIM_DMABURST_LENGTH_13TRANSFERS         LL_TIM_DMABURST_LENGTH_13TRANSFERS
#define LL_TIM_DMABURST_LENGTH_14TRANSFERS         LL_TIM_DMABURST_LENGTH_14TRANSFERS
#define LL_TIM_DMABURST_LENGTH_15TRANSFERS         LL_TIM_DMABURST_LENGTH_15TRANSFERS
#define LL_TIM_DMABURST_LENGTH_16TRANSFERS         LL_TIM_DMABURST_LENGTH_16TRANSFERS
#define LL_TIM_DMABURST_LENGTH_17TRANSFERS         LL_TIM_DMABURST_LENGTH_17TRANSFERS
#define LL_TIM_DMABURST_LENGTH_18TRANSFERS         LL_TIM_DMABURST_LENGTH_18TRANSFERS
/**
  * @}
  */
...
uint16_t tmp_tim_icoppositepolarity_64 = (uint16_t)LL_TIM_IC_POLARITY_RISING;
uint16_t tmp_tim_icoppositeselection_64 = (uint16_t)LL_TIM_ACTIVEINPUT_DIRECTTI;
/* Select the Opposite Input Polarity */
if (TIM_ICInitTypeDef* TIM_ICInitStruct.ICPolarity == LL_TIM_IC_POLARITY_RISING)
{
tmp_tim_icoppositepolarity_64 = (uint16_t)LL_TIM_IC_POLARITY_FALLING;
}
else
{
tmp_tim_icoppositepolarity_64 = (uint16_t)LL_TIM_IC_POLARITY_RISING;
}
/* Select the Opposite Input */
if (TIM_ICInitTypeDef* TIM_ICInitStruct.ICActiveInput == LL_TIM_ACTIVEINPUT_DIRECTTI)
{
tmp_tim_icoppositeselection_64 = (uint16_t)LL_TIM_ACTIVEINPUT_INDIRECTTI;
}
else
{
tmp_tim_icoppositeselection_64 = (uint16_t)LL_TIM_ACTIVEINPUT_INDIRECTTI;
...
LL_TIM_IC_SetActiveInput(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH2, tmp_tim_icoppositeselection_64);
LL_TIM_IC_SetFilter(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH2, TIM_ICInitTypeDef* TIM_ICInitStruct.ICFilter);
LL_TIM_IC_SetPolarity(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH2, tmp_tim_icoppositepolarity_64);
