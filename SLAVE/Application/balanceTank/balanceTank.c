...
void Control_Init(void)
{
    ...
    set_increment_pid(&pitch_inc_pid, 0.2, 0, 0.05, 0, 10);
    set_increment_pid(&roll_inc_pid, 0.2, 0, 0.05, 0, 10);
}
...
void Control_loop(void)
{
    ...
    ServoControl(110 + 12 * pitch_inc_pid.output, 110 - 12 * roll_inc_pid.output, 110 - 12 * pitch_inc_pid.output, 110 + 12 * roll_inc_pid.output);
}
