...
// static ServoInstance sender_configuration[6] = {
//     [0] = {}

// };
/**
 * @brief servo regisiter function
 *
 * @param Servo_Init_Config: servo configuration structure
 */
...
{
    switch (Servo_Motor->Servo_type) // angle limit
    {
    case Servo180:
        if (S_angle > 180)
            S_angle = 180;
