...
#define LL_FLASH_LATENCY_8                ((uint8_t)0x0008)  /*!< FLASH Eight Latency cycles    */
#define LL_FLASH_LATENCY_9                ((uint8_t)0x0009)  /*!< FLASH Nine Latency cycles     */
#define LL_FLASH_LATENCY_10               ((uint8_t)0x000A)  /*!< FLASH Ten Latency cycles      */
#define LL_FLASH_LATENCY_11               ((uint8_t)0x000B)  /*!< FLASH Eleven Latency cycles   */
#define LL_FLASH_LATENCY_12               ((uint8_t)0x000C)  /*!< FLASH Twelve Latency cycles   */
#define LL_FLASH_LATENCY_13               ((uint8_t)0x000D)  /*!< FLASH Thirteen Latency cycles */
#define LL_FLASH_LATENCY_14               ((uint8_t)0x000E)  /*!< FLASH Fourteen Latency cycles */
#define LL_FLASH_LATENCY_15               ((uint8_t)0x000F)  /*!< FLASH Fifteen Latency cycles  */


#define IS_FLASH_LATENCY(LATENCY) (((LATENCY) == LL_FLASH_LATENCY_0)  || \
                                   ...
                                   ((LATENCY) == LL_FLASH_LATENCY_9)  || \
                                   ((LATENCY) == LL_FLASH_LATENCY_10) || \
                                   ((LATENCY) == LL_FLASH_LATENCY_11) || \
                                   ((LATENCY) == LL_FLASH_LATENCY_12) || \
                                   ((LATENCY) == LL_FLASH_LATENCY_13) || \
                                   ((LATENCY) == LL_FLASH_LATENCY_14) || \
                                   ((LATENCY) == LL_FLASH_LATENCY_15))
/**
  * @}
  */ 
