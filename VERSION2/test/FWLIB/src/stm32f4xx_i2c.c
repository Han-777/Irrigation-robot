...
/**
  ...
  * @retval None
  */
void LL_I2C_DeInit(I2C_TypeDef* I2Cx)
{
...
void LL_I2C_Init(I2C_TypeDef* I2Cx, LL_I2C_InitTypeDef* I2C_InitStruct)
{
  ...
  assert_param(IS_I2C_MODE(I2C_InitStruct->PeripheralMode));
  assert_param(IS_I2C_DUTY_CYCLE(I2C_InitStruct->DutyCycle));
  assert_param(IS_I2C_OWN_ADDRESS1(I2C_InitStruct->OwnAddress1));
  assert_param(IS_I2C_ACK_STATE(I2C_InitStruct->TypeAcknowledge));
  assert_param(IS_I2C_ACKNOWLEDGE_ADDRESS(I2C_InitStruct->OwnAddrSize));
...
/*---------------------------- I2Cx CCR Configuration ------------------------*/
  ...
  if (I2C_InitStruct->ClockSpeed <= 100000)
  {
  ...
  else /*(I2C_InitStruct->ClockSpeed <= 400000)*/
  {
    if (I2C_InitStruct->DutyCycle == LL_I2C_DUTYCYCLE_2)
    {
      /* Fast mode speed calculate: Tlow/Thigh = 2 */
      result = (uint16_t)(pclk1 / (I2C_InitStruct->ClockSpeed * 3));
    }
    else /*I2C_InitStruct->DutyCycle == LL_I2C_DUTYCYCLE_16_9*/
    {
      /* Fast mode speed calculate: Tlow/Thigh = 16/9 */
      result = (uint16_t)(pclk1 / (I2C_InitStruct->ClockSpeed * 25));
      /* Set DUTY bit */
      result |= LL_I2C_DUTYCYCLE_16_9;
    }
...
/*---------------------------- I2Cx CR1 Configuration ------------------------*/
  ...
  tmpreg |= (uint16_t)((uint32_t)I2C_InitStruct->PeripheralMode | I2C_InitStruct->TypeAcknowledge);
  /* Write to I2Cx CR1 */
  I2Cx->CR1 = tmpreg;

/*---------------------------- I2Cx OAR1 Configuration -----------------------*/
  /* Set I2Cx Own Address1 and acknowledged address */
  I2Cx->OAR1 = (I2C_InitStruct->OwnAddrSize | I2C_InitStruct->OwnAddress1);
}
...
/*---------------- Reset I2C init structure parameters values ----------------*/
  ...
  I2C_InitStruct->ClockSpeed = 5000;
...
/**
  ...
  * @retval None
  */
void LL_I2C_SetDigitalFilter(I2C_TypeDef* I2Cx, uint16_t I2C_DigitalFilter)
{
  uint16_t tmpreg = 0;
...
/**
  ...
  * @retval None.
  */
void LL_I2C_SetOwnAddress2(I2C_TypeDef* I2Cx, uint8_t Address)
{
  uint16_t tmpreg = 0;
...
/**
  ...
  * @retval None
  */
void LL_I2C_SetDutyCycle(I2C_TypeDef* I2Cx, uint16_t I2C_DutyCycle)
{
  /* Check the parameters */
  assert_param(IS_I2C_ALL_PERIPH(I2Cx));
  assert_param(IS_I2C_DUTY_CYCLE(I2C_DutyCycle));
  if (I2C_DutyCycle != LL_I2C_DUTYCYCLE_16_9)
  {
    /* I2C fast mode Tlow/Thigh=2 */
    I2Cx->CCR &= LL_I2C_DUTYCYCLE_2;
  }
  else
  {
    /* I2C fast mode Tlow/Thigh=16/9 */
    I2Cx->CCR |= LL_I2C_DUTYCYCLE_16_9;
  }
}
...
/**
  ...
  */
uint8_t LL_I2C_GetSMBusPEC(I2C_TypeDef* I2Cx)
{
  /* Check the parameters */
  assert_param(IS_I2C_ALL_PERIPH(I2Cx));
...
/**
  ...
  */
uint32_t tmp_i2c_lastevent_72  = 0;
uint32_t tmp_i2c_flag1_72 = 0, tmp_i2c_flag2_72 = 0;
tmp_i2c_flag1_72 = I2C_TypeDef* I2Cx->SR1;
tmp_i2c_flag2_72 = I2C_TypeDef* I2Cx->SR2;
tmp_i2c_flag2_72 = tmp_i2c_flag2_72 << 16;
tmp_i2c_lastevent_72 = (tmp_i2c_flag1_72 | tmp_i2c_flag2_72) & 0x00FFFFFF;
uint32_t tmp_i2c_lastevent_72
{
  uint32_t lastevent = 0;
  uint32_t flag1 = 0, flag2 = 0;
