...
#define WATER_PE_GPIO_Pin GPIO_PIN_5
#define WATER_PE_GPIO_GPIO_Port GPIOI
#define RIGHT_PE_GPIO_Pin GPIO_PIN_4
#define RIGHT_PE_GPIO_GPIO_Port GPIOI
#define GRAY12_GPIO_Pin GPIO_PIN_5
#define GRAY12_GPIO_GPIO_Port GPIOD
#define GRAY11_GPIO_Pin GPIO_PIN_4
#define GRAY11_GPIO_GPIO_Port GPIOD
#define RLD_UART4_TX_Pin GPIO_PIN_10
#define RLD_UART4_TX_GPIO_Port GPIOC
#define GRAY13_GPIO_Pin GPIO_PIN_6
#define GRAY13_GPIO_GPIO_Port GPIOD
#define GRAY10_GPIO_Pin GPIO_PIN_3
#define GRAY10_GPIO_GPIO_Port GPIOD
#define RLD_UART4_RX_Pin GPIO_PIN_11
#define RLD_UART4_RX_GPIO_Port GPIOC
#define GRAY2_GPIO_Pin GPIO_PIN_3
#define GRAY2_GPIO_GPIO_Port GPIOB
#define GRAY14_GPIO_Pin GPIO_PIN_7
#define GRAY14_GPIO_GPIO_Port GPIOD
#define GYRO_UART5_TX_Pin GPIO_PIN_12
#define GYRO_UART5_TX_GPIO_Port GPIOC
#define LEFT_PE_GPIO_Pin GPIO_PIN_3
#define LEFT_PE_GPIO_GPIO_Port GPIOI
...
#define GRAY6_GPIO_Pin GPIO_PIN_2
#define GRAY6_GPIO_GPIO_Port GPIOC
#define GRAY7_GPIO_Pin GPIO_PIN_3
...
#define GRAY1_GPIO_Pin GPIO_PIN_2
#define GRAY1_GPIO_GPIO_Port GPIOB
#define GRAY8_GPIO_Pin GPIO_PIN_4
#define GRAY8_GPIO_GPIO_Port GPIOC
#define GRAY4_GPIO_Pin GPIO_PIN_15
#define GRAY4_GPIO_GPIO_Port GPIOB
#define LLD_USART2_RX_Pin GPIO_PIN_3
#define LLD_USART2_RX_GPIO_Port GPIOA
#define GRAY9_GPIO_Pin GPIO_PIN_5
#define GRAY9_GPIO_GPIO_Port GPIOC
#define GRAY3_GPIO_Pin GPIO_PIN_14
