...
#define read_key1 GPIO_ReadInputDataBit(GPIOF,GPIO_Pin_2)//读取按键io电平//列
#define read_key2 GPIO_ReadInputDataBit(GPIOF,GPIO_Pin_0)
#define read_key3 GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_15)

//#define read_key4 gpio_get_level(P20_2)


#define set_key1 GPIO_SetBits(GPIOD,GPIO_Pin_14)//设置按键io电平为高//8
#define set_key2 GPIO_SetBits(GPIOD,GPIO_Pin_9)
#define set_key3 GPIO_SetBits(GPIOF,GPIO_Pin_4)
//#define set_key4 gpio_set_level(P23_1,1)//1

#define reset_key1 GPIO_ResetBits(GPIOD,GPIO_Pin_14)//设置按键io电平为低
#define reset_key2 GPIO_ResetBits(GPIOD,GPIO_Pin_9)
#define reset_key3 GPIO_ResetBits(GPIOF,GPIO_Pin_4)
