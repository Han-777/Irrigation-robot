...
#define LL_EXTI_LINE_18      ((uint32_t)0x40000)     /*!< External interrupt line 18 Connected to the USB OTG FS Wakeup from suspend event */                                    
#define LL_EXTI_LINE_19      ((uint32_t)0x80000)     /*!< External interrupt line 19 Connected to the Ethernet Wakeup event */
#define LL_EXTI_LINE_20      ((uint32_t)0x00100000)  /*!< External interrupt line 20 Connected to the USB OTG HS (configured in FS) Wakeup event  */
#define LL_EXTI_LINE_21      ((uint32_t)0x00200000)  /*!< External interrupt line 21 Connected to the RTC Tamper and Time Stamp events */                                               
#define LL_EXTI_LINE_22      ((uint32_t)0x00400000)  /*!< External interrupt line 22 Connected to the RTC Wakeup event */                                               
...
#define IS_GET_EXTI_LINE(LINE) (((LINE) == LL_EXTI_LINE_0) || ((LINE) == LL_EXTI_LINE_1) || \
                                ...
                                ((LINE) == LL_EXTI_LINE_20) || ((LINE) == LL_EXTI_LINE_21) ||\
