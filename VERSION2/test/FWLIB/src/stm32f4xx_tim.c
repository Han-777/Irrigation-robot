...
void LL_TIM_Init(TIM_TypeDef* TIMx, LL_TIM_InitTypeDef* TIM_TimeBaseInitStruct)
{
  ...
  /* Check the parameters */
  assert_param(IS_TIM_ALL_PERIPH(TIMx)); 
  assert_param(IS_TIM_COUNTER_MODE(TIM_TimeBaseInitStruct->CounterMode));
  assert_param(IS_TIM_CKD_DIV(TIM_TimeBaseInitStruct->ClockDivision));
     ...
     (TIMx == TIM4) || (TIMx == TIM5)) 
  {
    ...
    tmpcr1 |= (uint32_t)TIM_TimeBaseInitStruct->CounterMode;
  }
  ...
  if((TIMx != TIM6) && (TIMx != TIM7))
  {
    ...
    tmpcr1 |= (uint32_t)TIM_TimeBaseInitStruct->ClockDivision;
  }

  TIMx->CR1 = tmpcr1;

  /* Set the Autoreload value */
  TIMx->ARR = TIM_TimeBaseInitStruct->Autoreload ;
...
void LL_TIM_StructInit(LL_TIM_InitTypeDef* TIM_TimeBaseInitStruct)
{
  ...
  TIM_TimeBaseInitStruct->Autoreload = 0xFFFFFFFF;
...
void LL_TIM_SetUpdateSource(TIM_TypeDef* TIMx, uint16_t TIM_UpdateSource)
{
  ...
  if (TIM_UpdateSource != LL_TIM_UPDATESOURCE_REGULAR)
  {
    /* Set the URS Bit */
...
void LL_TIM_OC_Init(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH1, LL_TIM_OC_InitTypeDef* TIM_OCInitStruct)
{
  ...
  /* Check the parameters */
  assert_param(IS_TIM_LIST1_PERIPH(TIMx)); 
  assert_param(IS_TIM_OC_MODE(TIM_OCInitStruct->OCMode));
  assert_param(IS_TIM_OUTPUT_STATE(TIM_OCInitStruct->OCState));
  assert_param(IS_TIM_OC_POLARITY(TIM_OCInitStruct->OCPolarity));   
  ...
  tmpccer |= TIM_OCInitStruct->OCState;
    
  if((TIMx == TIM1) || (TIMx == TIM8))
  {
    assert_param(IS_TIM_OUTPUTN_STATE(TIM_OCInitStruct->OCNState));
    assert_param(IS_TIM_OCN_POLARITY(TIM_OCInitStruct->OCNPolarity));
    assert_param(IS_TIM_OCNIDLE_STATE(TIM_OCInitStruct->OCNIdleState));
    assert_param(IS_TIM_OCIDLE_STATE(TIM_OCInitStruct->OCIdleState));
    ...
    tmpccer |= TIM_OCInitStruct->OCNState;
  ...
  TIMx->CCR1 = TIM_OCInitStruct->CompareValue;
...
void LL_TIM_OC_Init(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH2, LL_TIM_OC_InitTypeDef* TIM_OCInitStruct)
{
  ...
  /* Set the Output Compare Polarity */
  tmpccer |= (uint16_t)(TIM_OCInitStruct->OCPolarity << 4);
  
  /* Set the Output State */
  tmpccer |= (uint16_t)(TIM_OCInitStruct->OCState << 4);
  ...
  if((TIMx == TIM1) || (TIMx == TIM8))
  {
    ...
    /* Set the Output N Polarity */
    tmpccer |= (uint16_t)(TIM_OCInitStruct->OCNPolarity << 4);
    /* Reset the Output N State */
    tmpccer &= (uint16_t)~TIM_CCER_CC2NE;
    
    /* Set the Output N State */
    tmpccer |= (uint16_t)(TIM_OCInitStruct->OCNState << 4);
    /* Reset the Output Compare and Output Compare N IDLE State */
    tmpcr2 &= (uint16_t)~TIM_CR2_OIS2;
    tmpcr2 &= (uint16_t)~TIM_CR2_OIS2N;
    /* Set the Output Idle state */
    tmpcr2 |= (uint16_t)(TIM_OCInitStruct->OCIdleState << 2);
    /* Set the Output N Idle state */
    tmpcr2 |= (uint16_t)(TIM_OCInitStruct->OCNIdleState << 2);
  }
  /* Write to TIMx CR2 */
  TIMx->CR2 = tmpcr2;
  ...
  /* Set the Capture Compare Register value */
  TIMx->CCR2 = TIM_OCInitStruct->CompareValue;
...
void LL_TIM_OC_Init(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH3, LL_TIM_OC_InitTypeDef* TIM_OCInitStruct)
{
  ...
  /* Set the Output Compare Polarity */
  tmpccer |= (uint16_t)(TIM_OCInitStruct->OCPolarity << 8);
  
  /* Set the Output State */
  tmpccer |= (uint16_t)(TIM_OCInitStruct->OCState << 8);
  ...
  if((TIMx == TIM1) || (TIMx == TIM8))
  {
    ...
    /* Set the Output N Polarity */
    tmpccer |= (uint16_t)(TIM_OCInitStruct->OCNPolarity << 8);
    /* Reset the Output N State */
    tmpccer &= (uint16_t)~TIM_CCER_CC3NE;
    
    /* Set the Output N State */
    tmpccer |= (uint16_t)(TIM_OCInitStruct->OCNState << 8);
    /* Reset the Output Compare and Output Compare N IDLE State */
    tmpcr2 &= (uint16_t)~TIM_CR2_OIS3;
    tmpcr2 &= (uint16_t)~TIM_CR2_OIS3N;
    /* Set the Output Idle state */
    tmpcr2 |= (uint16_t)(TIM_OCInitStruct->OCIdleState << 4);
    /* Set the Output N Idle state */
    tmpcr2 |= (uint16_t)(TIM_OCInitStruct->OCNIdleState << 4);
  }
  /* Write to TIMx CR2 */
  TIMx->CR2 = tmpcr2;
  ...
  /* Set the Capture Compare Register value */
  TIMx->CCR3 = TIM_OCInitStruct->CompareValue;
...
void LL_TIM_OC_Init(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH4, LL_TIM_OC_InitTypeDef* TIM_OCInitStruct)
{
  ...
  /* Set the Output Compare Polarity */
  tmpccer |= (uint16_t)(TIM_OCInitStruct->OCPolarity << 12);
  
  /* Set the Output State */
  tmpccer |= (uint16_t)(TIM_OCInitStruct->OCState << 12);
  ...
  if((TIMx == TIM1) || (TIMx == TIM8))
  {
    ...
    /* Set the Output Idle state */
    tmpcr2 |= (uint16_t)(TIM_OCInitStruct->OCIdleState << 6);
  }
  /* Write to TIMx CR2 */
  TIMx->CR2 = tmpcr2;
  ...
  /* Set the Capture Compare Register value */
  TIMx->CCR4 = TIM_OCInitStruct->CompareValue;
...
{
  /* Set the default configuration */
  TIM_OCInitStruct->OCMode = LL_TIM_OCMODE_FROZEN;
  TIM_OCInitStruct->OCState = LL_TIM_OCSTATE_DISABLE;
  TIM_OCInitStruct->OCNState = LL_TIM_OCSTATE_DISABLE;
  TIM_OCInitStruct->CompareValue = 0x00000000;
  TIM_OCInitStruct->OCPolarity = LL_TIM_OCPOLARITY_HIGH;
  TIM_OCInitStruct->OCNPolarity = LL_TIM_OCPOLARITY_HIGH;
  TIM_OCInitStruct->OCIdleState = LL_TIM_OCIDLESTATE_LOW;
  TIM_OCInitStruct->OCNIdleState = LL_TIM_OCIDLESTATE_LOW;
}
...
void LL_TIM_OC_SetMode(TIM_TypeDef* TIMx, uint16_t TIM_Channel, uint16_t TIM_OCMode)
{
  ...
  if((TIM_Channel == LL_TIM_CHANNEL_CH1) ||(TIM_Channel == LL_TIM_CHANNEL_CH3))
  {
    tmp += (TIM_Channel>>1);
...
/**
  ...
  * @retval None
  */
void LL_TIM_OC_SetCompareCH1(TIM_TypeDef* TIMx, uint32_t Compare1)
{
  /* Check the parameters */
  assert_param(IS_TIM_LIST1_PERIPH(TIMx));
...
/**
  ...
  * @retval None
  */
void LL_TIM_OC_SetCompareCH2(TIM_TypeDef* TIMx, uint32_t Compare2)
{
  /* Check the parameters */
  assert_param(IS_TIM_LIST2_PERIPH(TIMx));
...
/**
  ...
  * @retval None
  */
void LL_TIM_OC_SetCompareCH3(TIM_TypeDef* TIMx, uint32_t Compare3)
{
  /* Check the parameters */
  assert_param(IS_TIM_LIST3_PERIPH(TIMx));
...
/**
  ...
  * @retval None
  */
void LL_TIM_OC_SetCompareCH4(TIM_TypeDef* TIMx, uint32_t Compare4)
{
  /* Check the parameters */
  assert_param(IS_TIM_LIST3_PERIPH(TIMx));
...
void LL_TIM_IC_Init(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH1, &LL_TIM_IC_InitTypeDef* TIM_ICInitStruct)
{
  /* Check the parameters */
  assert_param(IS_TIM_LIST1_PERIPH(TIMx));
  assert_param(IS_TIM_IC_POLARITY(TIM_ICInitStruct->ICPolarity));
  assert_param(IS_TIM_IC_SELECTION(TIM_ICInitStruct->ICActiveInput));
  assert_param(IS_TIM_IC_PRESCALER(TIM_ICInitStruct->ICPrescaler));
  assert_param(IS_TIM_IC_FILTER(TIM_ICInitStruct->ICFilter));
  
  {
    /* TI1 Configuration */
    TI1_Config(TIMx, TIM_ICInitStruct->ICPolarity,
               TIM_ICInitStruct->ICActiveInput,
               TIM_ICInitStruct->ICFilter);
    /* Set the Input Capture Prescaler value */
    LL_TIM_IC_SetPrescaler(TIMx, LL_TIM_CHANNEL_CH1, TIM_ICInitStruct->ICPrescaler);
  }
  {
    /* TI2 Configuration */
    assert_param(IS_TIM_LIST2_PERIPH(TIMx));
    TI2_Config(TIMx, TIM_ICInitStruct->ICPolarity,
               TIM_ICInitStruct->ICActiveInput,
               TIM_ICInitStruct->ICFilter);
    /* Set the Input Capture Prescaler value */
    LL_TIM_IC_SetPrescaler(TIMx, LL_TIM_CHANNEL_CH2, TIM_ICInitStruct->ICPrescaler);
  }
  {
    /* TI3 Configuration */
    assert_param(IS_TIM_LIST3_PERIPH(TIMx));
    TI3_Config(TIMx,  TIM_ICInitStruct->ICPolarity,
               TIM_ICInitStruct->ICActiveInput,
               TIM_ICInitStruct->ICFilter);
    /* Set the Input Capture Prescaler value */
    LL_TIM_IC_SetPrescaler(TIMx, LL_TIM_CHANNEL_CH3, TIM_ICInitStruct->ICPrescaler);
  }
  else
  {
    /* TI4 Configuration */
    assert_param(IS_TIM_LIST3_PERIPH(TIMx));
    TI4_Config(TIMx, TIM_ICInitStruct->ICPolarity,
               TIM_ICInitStruct->ICActiveInput,
               TIM_ICInitStruct->ICFilter);
    /* Set the Input Capture Prescaler value */
    LL_TIM_IC_SetPrescaler(TIMx, LL_TIM_CHANNEL_CH4, TIM_ICInitStruct->ICPrescaler);
  }
}
...
/**
  ...
  * @retval None
  */
uint16_t tmp_tim_icoppositepolarity_84 = (uint16_t)LL_TIM_IC_POLARITY_RISING;
uint16_t tmp_tim_icoppositeselection_84 = (uint16_t)LL_TIM_ACTIVEINPUT_DIRECTTI;
/* Select the Opposite Input Polarity */
if (TIM_ICInitTypeDef* TIM_ICInitStruct.ICPolarity == LL_TIM_IC_POLARITY_RISING)
{
tmp_tim_icoppositepolarity_84 = (uint16_t)LL_TIM_IC_POLARITY_FALLING;
}
else
{
tmp_tim_icoppositepolarity_84 = (uint16_t)LL_TIM_IC_POLARITY_RISING;
}
/* Select the Opposite Input */
if (TIM_ICInitTypeDef* TIM_ICInitStruct.ICActiveInput == LL_TIM_ACTIVEINPUT_DIRECTTI)
{
tmp_tim_icoppositeselection_84 = (uint16_t)LL_TIM_ACTIVEINPUT_INDIRECTTI;
}
else
{
tmp_tim_icoppositeselection_84 = (uint16_t)LL_TIM_ACTIVEINPUT_INDIRECTTI;
...
LL_TIM_IC_SetActiveInput(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH2, tmp_tim_icoppositeselection_84);
LL_TIM_IC_SetFilter(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH2, TIM_ICInitTypeDef* TIM_ICInitStruct.ICFilter);
LL_TIM_IC_SetPolarity(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH2, tmp_tim_icoppositepolarity_84);
...
{
  uint16_t icoppositepolarity = LL_TIM_IC_POLARITY_RISING;
  uint16_t icoppositeselection = LL_TIM_ACTIVEINPUT_DIRECTTI;

  /* Check the parameters */
  assert_param(IS_TIM_LIST2_PERIPH(TIMx));

  /* Select the Opposite Input Polarity */
  if (TIM_ICInitStruct->ICPolarity == LL_TIM_IC_POLARITY_RISING)
  {
    icoppositepolarity = LL_TIM_IC_POLARITY_FALLING;
  }
  else
  {
    icoppositepolarity = LL_TIM_IC_POLARITY_RISING;
  }
  /* Select the Opposite Input */
  if (TIM_ICInitStruct->ICActiveInput == LL_TIM_ACTIVEINPUT_DIRECTTI)
  {
    icoppositeselection = LL_TIM_ACTIVEINPUT_INDIRECTTI;
  }
  else
  {
    icoppositeselection = LL_TIM_ACTIVEINPUT_DIRECTTI;
  }
  {
    /* TI1 Configuration */
    TI1_Config(TIMx, TIM_ICInitStruct->ICPolarity, TIM_ICInitStruct->ICActiveInput,
               TIM_ICInitStruct->ICFilter);
    /* Set the Input Capture Prescaler value */
    LL_TIM_IC_SetPrescaler(TIMx, LL_TIM_CHANNEL_CH1, TIM_ICInitStruct->ICPrescaler);
    /* TI2 Configuration */
    TI2_Config(TIMx, icoppositepolarity, icoppositeselection, TIM_ICInitStruct->ICFilter);
    /* Set the Input Capture Prescaler value */
    LL_TIM_IC_SetPrescaler(TIMx, LL_TIM_CHANNEL_CH2, TIM_ICInitStruct->ICPrescaler);
  }
  else
  { 
    /* TI2 Configuration */
    TI2_Config(TIMx, TIM_ICInitStruct->ICPolarity, TIM_ICInitStruct->ICActiveInput,
               TIM_ICInitStruct->ICFilter);
    /* Set the Input Capture Prescaler value */
    LL_TIM_IC_SetPrescaler(TIMx, LL_TIM_CHANNEL_CH2, TIM_ICInitStruct->ICPrescaler);
    /* TI1 Configuration */
    TI1_Config(TIMx, icoppositepolarity, icoppositeselection, TIM_ICInitStruct->ICFilter);
    /* Set the Input Capture Prescaler value */
    LL_TIM_IC_SetPrescaler(TIMx, LL_TIM_CHANNEL_CH1, TIM_ICInitStruct->ICPrescaler);
  }
}
...
void LL_TIM_BDTR_Init(TIM_TypeDef* TIMx, LL_TIM_BDTR_InitTypeDef *TIM_BDTRInitStruct)
{
  /* Check the parameters */
  assert_param(IS_TIM_LIST4_PERIPH(TIMx));
  assert_param(IS_TIM_OSSR_STATE(TIM_BDTRInitStruct->OSSRState));
  assert_param(IS_TIM_OSSI_STATE(TIM_BDTRInitStruct->OSSIState));
  assert_param(IS_TIM_LOCK_LEVEL(TIM_BDTRInitStruct->LockLevel));
  assert_param(IS_TIM_BREAK_STATE(TIM_BDTRInitStruct->BreakState));
  assert_param(IS_TIM_BREAK_POLARITY(TIM_BDTRInitStruct->BreakPolarity));
  assert_param(IS_TIM_AUTOMATIC_OUTPUT_STATE(TIM_BDTRInitStruct->AutomaticOutput));

  /* Set the Lock level, the Break enable Bit and the Polarity, the OSSR State,
     the OSSI State, the dead time value and the Automatic Output Enable Bit */
  TIMx->BDTR = (uint32_t)TIM_BDTRInitStruct->OSSRState | TIM_BDTRInitStruct->OSSIState |
             TIM_BDTRInitStruct->LockLevel | TIM_BDTRInitStruct->DeadTime |
             TIM_BDTRInitStruct->BreakState | TIM_BDTRInitStruct->BreakStatePolarity |
...
void LL_TIM_SetSlaveMode(TIM_TypeDef* TIMx, (TIM_SMCR_SMS_2 | TIM_SMCR_SMS_1 | TIM_SMCR_SMS_0))
{
  ...
  LL_TIM_SetTriggerInput(TIMx, TIM_InputTriggerSource);
                                ...
                                uint16_t TIM_ICPolarity, uint16_t ICFilter)
{
  ...
  if (TIM_TIxExternalCLKSource == LL_TIM_TS_TI2FP2)
  {
    TI2_Config(TIMx, TIM_ICPolarity, LL_TIM_ACTIVEINPUT_DIRECTTI, ICFilter);
  }
  else
  {
    TI1_Config(TIMx, TIM_ICPolarity, LL_TIM_ACTIVEINPUT_DIRECTTI, ICFilter);
  }
  /* Select the Trigger source */
  LL_TIM_SetTriggerInput(TIMx, TIM_TIxExternalCLKSource);
  /* Select the External clock mode1 */
  TIMx->SMCR |= TIM_SlaveMode_External1;
}
...
void LL_TIM_SetTriggerInput(TIM_TypeDef* TIMx, LL_TIM_TS_ETRF)
{
  ...
  LL_TIM_ConfigETR(TIMx, TIM_ExtTRGPolarity, TIM_ExtTRGPrescaler, ExtTRGFilter);
...
/**
  ...
  * @retval None
  */
void LL_TIM_SetRemap(TIM_TypeDef* TIMx, uint16_t TIM_Remap)
{
 /* Check the parameters */
