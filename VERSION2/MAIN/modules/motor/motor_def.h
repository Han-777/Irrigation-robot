...
typedef struct
{
    Motor_Controller_Init_s controller_param_init_config;   // 控制器参数（宏观）
    Motor_Control_Setting_s controller_setting_init_config; // controller 具体用了哪些环（微观）_
    Motor_Type_e motor_type;
    CAN_Init_Config_s can_init_config; // refer to communication
} Motor_Init_Config_s;
